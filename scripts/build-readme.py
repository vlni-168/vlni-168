...
for level in range(highest_level, 0, -1):
    ...
    icons = []
    for slug in slugs:
        icon_html = f'<img src="{BASE_URL}?name={slug}&theme=dark&size=32&bg={fill_color}" alt="{slug}" style="height:32px;vertical-align:middle;padding:3px;border-radius:8px;" />'
